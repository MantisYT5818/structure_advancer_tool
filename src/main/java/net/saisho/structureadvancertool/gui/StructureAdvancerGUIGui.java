...
public class StructureAdvancerGUIGui extends StructureAdvancerToolModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public StructureAdvancerGUIGui(StructureAdvancerToolModElements instance) {
		super(instance, 2);
